/**
 * `@dataverket/sops-age-files` — one SOPS-encrypted JSON file per secret.
 *
...
/** The provider behind `@dataverket/sops-age-files`. */
...
/** `@dataverket/sops-age-files`: one SOPS-encrypted file per secret; a writer needs only the recipients' public keys. */
export const vault = {
